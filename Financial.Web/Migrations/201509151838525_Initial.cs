    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.Budget, t.ApplicationUser })
                .ForeignKey("dbo.AspNetUsers", t => t.Budget, cascadeDelete: true)
                .ForeignKey("dbo.Budgets", t => t.ApplicationUser, cascadeDelete: true)
                .Index(t => t.Budget)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.UserBudgets", "ApplicationUser", "dbo.Budgets");
            DropForeignKey("dbo.UserBudgets", "Budget", "dbo.AspNetUsers");
            DropForeignKey("dbo.Transactions", "CategoryId", "dbo.Categories");
            DropForeignKey("dbo.Categories", "BudgetId", "dbo.Budgets");
            DropIndex("dbo.UserBudgets", new[] { "ApplicationUser" });
            DropIndex("dbo.UserBudgets", new[] { "Budget" });
